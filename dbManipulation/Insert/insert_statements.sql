...
INSERT INTO [dbo].[Accreditation] ([Name])
VALUES 
...
INSERT INTO [dbo].[Bursary_Fund] ([FundAmount])
VALUES 
    (15000000.00);

-- Inserting into Application_Status table
INSERT INTO [dbo].[Application_Status] ([Status])
VALUES 
    ('Pending'),
    ('Approved'),
    ('Rejected');
...
INSERT INTO [dbo].[Institute_Info] ([InstituteName], [ContactDetailsID], [BBDBursaryInstituteStatus])
VALUES 
    ('Institute A', 1, 2),
    ('Institute B', 2, 2),
    ('Institute C', 3, 1),
...
INSERT INTO [dbo].[Student] ([UserID], [ID_Number], [RaceID])
VALUES 
    (2, '1234567890123', 1),
    (3, '9876543210987', 2),
    (6, '5555555555555', 3),
...
INSERT INTO [dbo].[Head_Of_Department] ([InstituteID], [UserID])
VALUES 
    (1, 1),
    (2, 4),
    (3, 5),
...
INSERT INTO [dbo].[Institution_Fund_Allocation] ([InstituteID], [AllocatedAmount], [BursaryFundID])
VALUES 
    (1, 500000.00, 2024),
    (2, 125000.00, 2024),
    (5, 1500000.00, 2024),
...
INSERT INTO [dbo].[Institute_Accreditation] ([AccreditationID], [InstituteID])
VALUES 
    (1, 1),
    (2, 1),
    (3, 1),
...
INSERT INTO [dbo].[Courses] ([CourseName], [InstituteID])
VALUES 
    ('Computer Science', 1),
    ('Medicine', 2),
    ('Engineering', 3),
...
INSERT INTO [dbo].[Bursary_Applicants] ([StudentID], [HeadOfDepartmentID], [BursaryAmount], [InFinalYear], [Motivation], [BursaryApplicantStatus])
VALUES 
    ...
    (6, 10, 20000.00, 0, "Financial need combined with a strong academic record underscores the student's deserving candidacy.", 3),
    ...
    (10, 14, 40000.00, 0, "Recommendations from faculty or mentors attest to the student's character, work ethic, and potential contributions.", 2);

-- Inserting into Bursary_Applicant_Grades table
INSERT INTO [dbo].[Bursary_Applicant_Grades] ([CourseID], [Grade], [BursaryFundID])
VALUES 
    (1, 1, 80.5, 2024),
    (1, 1, 90.5, 2024),
    (1, 1, 100, 2024),
